...
// Article creation has been disabled
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
        <Card className="p-8 text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-2xl font-bold">Article Publishing Disabled</h1>
            <p className="text-muted-foreground max-w-md mx-auto">
              Article creation and publishing through the admin panel has been
              disabled. Please contact the site administrator if you need to
              publish content.
            </p>
          </div>
