  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <article className="max-w-4xl mx-auto px-4 sm-6 lg-8 py-8">
          <Link href="/">
          ...
          <h1 className="text-3xl sm-4xl lg-5xl font-bold mb-6" data-testid="text-article-title">
            {article.title}
          </h1>
          ...
          <div className="prose prose-lg max-w-none font-serif">
            {article.content.split('\n\n').map((paragraph, index) => (
              <p key={index} className="mb-6 text-base sm-lg leading-relaxed">
                {paragraph}
              </p>
            ))}
          </div>
        ...
        {relatedArticles.length > 0 && (
          <div className="border-t mt-12 pt-12 bg-card">
            <div className="max-w-7xl mx-auto px-4 sm-6 lg-8 pb-12">
              <h2 className="text-2xl sm-3xl font-bold mb-8">Related Stories</h2>
